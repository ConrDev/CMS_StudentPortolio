  ...
  <div id="rb-main">
    <div id="rb-left">
      ...
      <div class="box-contact">
        <p class="icoweb">
          <i class="fa fa-calendar"></i><span>22/12/1995</span>
        </p>
        <p class="icoweb"><i class="fa fa-user"></i><span>Men</span></p>
        <p class="icoweb"><i class="fa fa-phone"></i><span>0123456789</span></p>
        <p class="icoweb">
          <i class="fa fa-envelope-square"></i><span>example@example.com</span>
        </p>
        <p class="icoweb">
          <i class="fa fa-map-marker"></i><span>New York</span>
        </p>
          ...
          <div>
            <div class="rb-box-content">
              <div class="exp-content">
                ...
                placeat voluptates consequuntur
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            <div class="rb-box-content">
              <h3>
                ...
                <span class="exp-date"
                  ><em>08/2019</em> - <em>03/2020</em></span
                >
              </h3>
              <p class="h3">
                <span>Major</span>
          ...
          <div>
            <div class="rb-box-content">
              <h3>
                ...
                <span class="exp-date"
                  ><em>01/2019</em> - <em>03/2020</em></span
                >
              </h3>
              <p class="h3">
                <span>Position</span>
